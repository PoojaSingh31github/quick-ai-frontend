...
const WriteArticle = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      // Assuming the response contains the generated article
      setArticle(response.data.message);
      setLoading(false);
      setInput("");
      setSelectedLength(articleLength[0]); // Reset to default length
    } catch (error) {
      setLoading(false);
      toast.error("Failed to generate article. Please try again later.");
